...
TIM3 is a 1:1 USDA-backed token built on Arweave's AO network. Users lock USDA stablecoin as collateral and receive TIM3 tokens that maintain their value through full collateralization.
...
- **1:1 Collateral Backing**: Every TIM3 token backed by locked USDA
...
- **Full Collateralization**: 1:1 USDA backing ensures stable value
