-- Fix Lock Manager to work with USDA Transfer instead of Lock handlers
-- This updates the running Lock Manager process to use production USDA
...
Send({
    ...
    Action = "Eval",
    Data = "json = require('json'); " .. newLockHandler .. "; " .. creditNoticeHandler .. "; print('Lock Manager updated for Transfer-based USDA interaction')"
})

print("Lock Manager fix applied - now uses USDA Transfer instead of Lock handlers")
print("Check Lock Manager response with: Inbox[#Inbox]")